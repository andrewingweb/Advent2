...
!(function (t) {
  function e(t, e) {
    for (
      "string" == typeof e && (e = document.createElement(e)), t.appendChild(e);
      t.firstChild !== e;
  ...
  var o = "js-modal",
    ...
    X = function (t) {
      var e = P,
        ...
        u = t.modalText,
        m =
          "" !== t.modalDescribedById
            ? R + '="' + t.modalDescribedById + '"'
            : "";
              ...
              function (a) {
                ...
                if ((J(a.target, o) === !0 || "" !== d) && "click" === e) {
                  ...
                  l.insertAdjacentHTML(
                    "beforeEnd",
                    U({ text: B, backgroundEnabled: N, prefixClass: A })
                  ),
                    l.insertAdjacentHTML(
                      "beforeEnd",
                      X({
                ...
                var K = Q(a.target, p);
                if (
                  (a.target.getAttribute("id") === C ||
                    "" !== K ||
                    a.target.getAttribute("id") === D ||
                    J(a.target, p) === !0) &&
                  "click" === e
                ) {
                  var l = t.querySelector("body"),
                    ...
                    N = tt.getAttribute(H);
                  (a.target.getAttribute("id") === D && "disabled" === N) ||
                    (Y({
                      modal: V,
                      modalContent: Z,
                      overlay: tt,
                ...
                if (W(P) && "keydown" === e) {
                  ...
                  27 === a.keyCode &&
                    ...
                    G(l, S)),
                    9 === a.keyCode &&
                      dt.indexOf(a.target) >= 0 &&
                      (a.shiftKey
                        ? a.target === dt[0] &&
                          (dt[dt.length - 1].focus(), a.preventDefault())
                        : a.target === dt[dt.length - 1] &&
                          (dt[0].focus(), a.preventDefault())),
                    9 === a.keyCode &&
                      dt.indexOf(a.target) === -1 &&
                      (a.preventDefault(), dt[0].focus());
                }
              },
              !0
            );
  ...
  document.addEventListener("DOMContentLoaded", et),
    (window.van11yAccessibleModalWindowAria = tt);
})(document);
